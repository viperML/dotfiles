...
let
  ...
  xontrib-kitty = with my-python.pkgs; buildPythonPackage rec {
    pname = "xontrib-kitty";
    version = "0.0.2";
    src = fetchPypi {
  ...
  xontrib-onepath = with my-python.pkgs; buildPythonPackage rec {
  ...
  xonsh-direnv = with my-python.pkgs; buildPythonPackage rec {
    pname = "xonsh-direnv";
    version = "1.5.0";
    src = fetchPypi {
      inherit pname version;
  ...
  xontrib-prompt-starship = with my-python.pkgs; buildPythonPackage rec {
